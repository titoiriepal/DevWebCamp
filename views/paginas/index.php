...
<section class="resumen">
    <div class="resumen__grid">
        ...
        <div class="resumen__bloque">
            <div class="resumen__texto resumen__texto--numero">500</div>
            <div class="resumen__texto">Asistentes</div>
        </div>
        ...
        <?php foreach ($ponentes as $ponente) { ?>
            ...
            <div class="speaker">
                <picture>
                    ...
                    <img class="speaker__imagen" loading="lazy" width="200" height="300" src="<?php echo $ENV['HOST'] . '/img/speakers/' . $ponente->imagen . '.png'?>" alt="Imagen Ponete" height="100%" width="100%">
                </picture>
                ...
                <div class="speaker__informacion">
                    ...
                    <p class="speaker__ubicacion">
                        <?php echo $ponente->ciudad . ' - ' . $ponente->pais; ?> </p>
...
<section class="boletos">
    <h2 class="boletos__heading">Entradas & Precios</h2>
